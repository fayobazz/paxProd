"use client";
import Foo from "@/app/(site)/foo/page";
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
      <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
        ...
        <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in  Ethiopia's &amp; Catholic society. Have any query?</p>
      ...
      <div className="lg:mx-auto text-left ">
        <h4 className="text-lg text-gray-900 font-medium mb-7">PAX CTV</h4>
        <ul className="text-sm  transition-all duration-500">
          ...
          <li><a href="javascript:;" className=" text-gray-600 hover:text-gray-900">Blogs & News</a></li>
        </ul>
      </div>
      {/*End Col*/}
      <div className="lg:mx-auto text-left ">
        ...
        <ul className="text-sm  transition-all duration-500">
          <li className="mb-6"><a href="javascript:;" className="text-gray-600 hover:text-gray-900">Gallery</a></li>
          <li className="mb-6"><a href="javascript:;" className=" text-gray-600 hover:text-gray-900">Contact Us</a></li>
          <li><a href="javascript:;" className=" text-gray-600 hover:text-gray-900">Shop</a></li>
        </ul>
      </div>
      {/*End Col*/}
      <div className="lg:mx-auto text-left ">
    ...
    <div className="py-7 border-t border-gray-200">
      <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
        <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">PAX</a> 2024, All rights reserved.</span>
